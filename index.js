...
// this get's logged if date is higher
    ...
    console.log("Remus is younger than Mira"); // this get;s logged if not
...
// this will get logged
    ...
    console.log("Mohammed has more children than Rasla"); // if none of the statemens are true, this will be logged
if ((namelist[1].knowsHowToProgram, namelist[3].knowsHowToProgram) === true)
    ...
    console.log("LMGTFY"); //logs this otherwise
if (namelist[1].country === "Iceland")
    console.log("Hæ!"); //this follows the same rules as above
else if (namelist[1].country === "Spain ")
    console.log("Hola!");
else if (namelist[1].country === "Korea ")
    console.log("여보세요!");
else
    console.log("Hello");
switch (namelist[1].country //the switch statement is an alternative to the if/else
) {
